#This file looks for new folder inside user uploads and converts them into reel if they are not already converpipted
import os
import time
    ...
    with open ("done.txt", "r") as f:
      ...
      for folder in folders:
        if folder not in done_folders:
          text_to_audio(folder) # Generate the given text from desc.txt into speech or audio audio.mp3
          create_reel(folder) #Converts the images and audio into reel
